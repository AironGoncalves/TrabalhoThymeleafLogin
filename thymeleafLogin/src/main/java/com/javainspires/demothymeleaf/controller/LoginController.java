...
public class LoginController {
	...
	public String login(@ModelAttribute(name="loginForm") LoginForm loginForm, Model model) {
		...
		if("admin".equals(username) && "admin".equals(password)) {
			//se o usuário e a senha estiverem corretos iremos para página inicial home
			return "home";
		}
		// se a senha ou usuario estiver errado a página mantém na tela login e exibi a mensagem de erro            
